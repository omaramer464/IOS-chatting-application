...
*** Note: The project uses Firebase's firestore database, the GoogleService-info.plist file is removed from the project's files. To be able to use the application, create a firestore database on Firebase and download the GoogleServices-info file and add it to the project.
